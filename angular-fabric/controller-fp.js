...
kitchensink.controller('CanvasControls', function ($scope) {
    ...
    $scope.setLayout = function (type, image) {
        ...
        if (type === 'front') {
            ...
            fabric.Image.fromURL('images/KP_30L_' + OU + '.png', function (d30Limage) {
                deviceImg = d30Limage;
...
//        removeWelcome = welcome;
				...
				function addDatePlace(dateTop, dateLeft) {
						var datedefault = new fabric.Text("JULY 25-27\nBAYSIDE MARKETPLACE", {
								top:  dateTop,
								left: dateLeft,
								fontFamily: 'BrandonGrotesqueRegular',
								//fontWeight: 'bold',
						...
						canvas.add(datedefault);
				}
        addDatePlace(210, 450);			
			
				function addAddress(addressTop, addressLeft) {
						var addressdefault = new fabric.Text("401 BISCAYNE BLVD. R106\nMIAMI, FL 33132", {
								top:  addressTop,
								left: addressLeft,
								fontFamily: 'BrandonGrotesqueLight',
								fill: '#000',
						...
						canvas.add(addressdefault);
				}
        addAddress(260, 450);
			
			
        //Email BG
        fabric.Image.fromURL('images/MeetFire_Email_temp.png', function (bgImage) {
            bgImage.scale(1).set({
                top: 0,
                left: 0,
								selectable: false,
        		...
        		canvas.add(bgImage).sendToBack(bgImage);
        		emailBG = bgImage;
        });
        ...
        $scope.toggleBold = function () {
            $scope.setActiveStyle('fontFamily',
                                  $scope.getActiveStyle('fontFamily') === 'BrandonGrotesqueRegular' ? 'BrandonGrotesqueLight' : 'BrandonGrotesqueRegular');
        };
