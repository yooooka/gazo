...
//start message
	...
	var welcome = new fabric.IText(strings, {
        fontFamily: 'Arial',
...
/* Layout controll */
  ...
  $scope.addLayout1 = function() {
	...
	fabric.Image.fromURL('images/Kindle_Paperwhite_Logo.png', function(logo1) {
    logo1.scale(0.4).set({
        top: 30,
        left: 50,
...
/* Screen controll */
  ...
  function addImage(imageName) {
	var changeimg = new fabric.Image.fromURL('images/screen-' + imageName, function(screen) {
    removeimg = screen;
    screen.scale(1).set({
        top: 27,
        left: 517,
